...
class Plugin {
	...
	private function define_acf_hooks() {
		...
		$this->loader->add_filter( 'replicast_get_object_post_meta',         $acf, 'get_post_meta', 10, 2 );

		$this->loader->add_filter( 'replicast_suppress_object_meta_from_update', $acf, 'suppress_meta_from_update', 10 );
		$this->loader->add_action( 'replicast_update_object_post_meta',          $acf, 'update_post_meta' );
